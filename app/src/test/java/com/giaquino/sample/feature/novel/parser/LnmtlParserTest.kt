...
class LnmtlParserTest {

  val parser = LnmtlParser

  @Test fun validLnmtlResponse() {
    val data = loadResourceAsString("response/lnmtl_novel_response.txt")
    val content = loadResourceAsString("response/lnmtl_novel_response_content.txt")
